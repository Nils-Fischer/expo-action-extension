...
export type ActionExtensionPluginProps =
  | (ActionExtensionConfig & SharedConfig) // Single extension
  | ({ extensions: ActionExtensionConfig[] } & SharedConfig); // Multiple extensions
